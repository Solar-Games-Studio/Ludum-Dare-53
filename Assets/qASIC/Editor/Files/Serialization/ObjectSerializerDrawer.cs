...
namespace qASIC.Files.Serialization.Internal
{
    ...
    internal class ObjectSerializerDrawer : PropertyDrawer
    {
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            return EditorGUIUtility.singleLineHeight * 2f + EditorGUIUtility.standardVerticalSpacing * 7f + _providerHeight + _pathHeight + _LABEL_HEIGHT;
        }
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            GUI.Box(position, string.Empty, Styles.Background);
            qGUIEditorUtility.BorderAround(position);

            Rect labelRect = position
                .SetHeight(_LABEL_HEIGHT);

            Rect labelSeparatorRect = labelRect
                .ResizeToBottom(0f);
